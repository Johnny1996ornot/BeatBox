...
// Wait for HTML to load before grabbing elements
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('playBtn').addEventListener('click', (e) => {
        ...
        if (isPlaying) {
            ...
            playhead.style.display = 'block'; scheduler();
            e.target.innerText = "⏸ Stop Demo"; e.target.style.backgroundColor = 'var(--danger-color)';
        } else {
            window.clearTimeout(timerID); stopAllVocals(); playhead.style.display = 'none';
